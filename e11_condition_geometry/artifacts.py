...
MAIN_EVIDENCE_STAGES: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "paper_role": "Executable freeze boundary for the v5 transport-normalized score; current state remains not_ready until the validation Slurm output exists and passes gates.",
    },
    {
