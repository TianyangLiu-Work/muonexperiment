...
MAIN_EVIDENCE_STAGES: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "paper_role": "Executable freeze boundary that now selects the v5 transport-normalized score before final splits, while keeping any P0 claim pending final held-out evaluation.",
    },
    {
        ...
        "paper_role": "Pre-registered frozen-score evaluator for the two unspent v5 final splits; current state is not_run until the submitted final Slurm jobs write layer tables.",
    },
    {
        ...
        "paper_role": "Pre-output detectable-effect audit for the pending v5 final residual-Spearman gates, separating underpowered nulls from negative transport boundaries.",
    },
    {
        ...
        "paper_role": "Pre-output claim-state machine that locks how the pending v5 final results will be interpreted before their layer tables exist.",
    },
    {
