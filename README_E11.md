...
5. Use the natural boundary audit as a null primary-drift scan, then run a fresh pre-registered natural negative search if the paper needs natural counterexamples beyond component/outcome tradeoffs.
