...
The validation-freeze boundary is generated by
...
V4 is not a positive result yet; it still needs a validation-frozen scalar aggregation before either unspent final split can support a P0 claim.
The current freeze artifact remains `not_ready` until the validation split exists and a residual score passes before either unspent final split can support a P0 claim.
