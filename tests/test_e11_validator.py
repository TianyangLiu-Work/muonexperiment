    ...
    return pd.DataFrame(
        [
            ...
            },
            {
                ...
                "current_state": "Tectonic build works and discussion/e11_artifact_review_packet.md plus discussion/e11_camera_ready_package_audit.md document the serverREADME.md exclusion and GPU-pending boundary.",
                "required_next_evidence": "Run clean checkout after refreshing discussion/e11_artifact_review_packet.md and discussion/e11_camera_ready_package_audit.md.",
                "acceptance_gate": "A fresh checkout completes make e11-check, builds both PDFs, and records the exact command environment.",
                "compute_mode": "CPU",
                "planned_artifacts": "results/example/*; discussion/example.md; results/e11_artifact_review_packet/*; discussion/e11_artifact_review_packet.md; results/e11_camera_ready_package_audit/*; discussion/e11_camera_ready_package_audit.md",
