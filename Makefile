.PHONY: e11-main-results e11-cifar-results e11-cifar-resnet-results e11-cifar-resnet-rho002-results e11-cifar-resnet-checkpoint-sweep-results e11-cifar-resnet-condition-proxy-results e11-cifar-resnet-fc-condition-results e11-cifar-resnet-tail-quality-results e11-cifar-resnet-imbalance-sweep-results e11-cifar-resnet-layer-jvp-tail-quality-results e11-cifar-resnet-layer-jvp-checkpoint-prediction-results e11-cifar-resnet-condition-score-heldout-architecture-results e11-cifar-resnet-condition-score-heldout-data-results e11-cifar-resnet-condition-score-heldout-eval e11-cifar-resnet-condition-score-fresh-architecture-results e11-cifar-resnet-condition-score-fresh-data-results e11-cifar-resnet-condition-score-fresh-eval e11-cifar-resnet-condition-score-failure-audit e11-cifar-resnet-condition-score-v4-protocol e11-cifar-resnet-condition-score-v4-validation-results e11-cifar-resnet-condition-score-v4-validation-freeze e11-cifar-resnet-condition-score-v4-architecture-results e11-cifar-resnet-condition-score-v4-data-results e11-cifar-resnet-condition-score-v4-final-eval e11-cifar-resnet-condition-score-v4-failure-audit e11-condition-score-ablation e11-matrix-block-theorem-proof e11-matrix-block-tightness-audit e11-theory-proof-obligation-register e11-cifar-resnet-condition-score-v5-theory-protocol e11-cifar-resnet-condition-score-v5-theory-to-score-map e11-cifar-resnet-condition-score-v5-validation-results e11-cifar-resnet-condition-score-v5-validation-freeze e11-cifar-resnet-condition-score-v5-architecture-results e11-cifar-resnet-condition-score-v5-data-results e11-cifar-resnet-condition-score-v5-final-eval e11-cifar-resnet-condition-score-v5-final-power-audit e11-cifar-resnet-condition-score-v5-final-interpretation-plan e11-cifar-resnet-condition-score-v5-reviewer-failure-response e11-cifar-resnet-condition-score-v5-direction-guardrail-failure-audit e11-cifar-resnet-lt-standard-eval-results e11-cifar-resnet-lt-recipe-benchmark-results e11-cifar-resnet-lt-muon-final-benchmark-results e11-cifar-resnet-lt-tuned-benchmark-protocol e11-cifar-resnet-lt-tuned-benchmark-settings e11-cifar-resnet-lt-tuned-benchmark-refresh-discussions e11-cifar-resnet-lt-tuned-benchmark-validation-results e11-cifar-resnet-lt-tuned-benchmark-selection e11-cifar-resnet-lt-tuned-benchmark-interim-audit e11-cifar-resnet-lt-tuned-benchmark-leakage-audit e11-cifar-resnet-lt-tuned-benchmark-refresh-firewall e11-cifar-resnet-lt-tuned-benchmark-protocol-seal e11-cifar-resnet-lt-tuned-benchmark-fairness-audit e11-cifar-resnet-lt-tuned-benchmark-power-audit e11-cifar-resnet-lt-tuned-benchmark-variance-prior-audit e11-cifar-resnet-lt-tuned-benchmark-final-analysis-plan e11-cifar-resnet-lt-tuned-benchmark-final-robustness-plan e11-cifar-resnet-lt-tuned-benchmark-final-execution-plan e11-cifar-resnet-lt-tuned-benchmark-final-eval e11-cifar-resnet-lt-tuned-benchmark-final-launch-audit e11-cifar-resnet-lt-tuned-benchmark-final-safe-submit e11-cifar-resnet-lt-tuned-benchmark-slurm-plan e11-cifar-resnet-lt-tuned-benchmark-launch-audit e11-cifar-resnet-lt-tuned-benchmark-safe-submit e11-cifar-resnet-practical-muon-bridge-results e11-natural-head-tail-boundary-audit e11-natural-negative-search-protocol e11-natural-negative-search-phase1-power-audit e11-natural-negative-search-phase1-settings e11-natural-negative-search-phase1-results e11-natural-negative-search-phase1-eval e11-natural-negative-search-phase1-interim-synthesis e11-natural-negative-search-phase2-settings e11-natural-negative-search-phase2-results e11-natural-negative-search-phase2-eval e11-natural-negative-search-phase2-power-audit e11-heldout-generality-audit e11-bold-conjecture-register e11-muon-state-distribution-contract e11-top-conference-claim-decision-audit e11-manuscript-claim-trace e11-mechanism-referee-audit e11-submission-repro-audit e11-clean-worktree-replay-audit e11-pdf-render-boundary-audit e11-artifact-review-packet e11-camera-ready-package-audit e11-appendix-results e11-all-results e11-paper-assets e11-guardrail-assets e11-all-assets e11-paper-pdf e11-artifacts e11-validate e11-test e11-check e11-full
...
e11-condition-score-ablation: scripts/e11_write_condition_score_ablation.py
	$(PYTHON) scripts/e11_write_condition_score_ablation.py
...
e11-cifar-resnet-condition-score-v5-final-power-audit: scripts/e11_write_condition_score_v5_final_power_audit.py
	$(PYTHON) scripts/e11_write_condition_score_v5_final_power_audit.py
...
e11-cifar-resnet-condition-score-v5-direction-guardrail-failure-audit: scripts/e11_write_condition_score_v5_direction_guardrail_failure_audit.py
	$(PYTHON) scripts/e11_write_condition_score_v5_direction_guardrail_failure_audit.py
...
e11-clean-worktree-replay-audit: scripts/e11_write_clean_worktree_replay_audit.py
	$(PYTHON) scripts/e11_write_clean_worktree_replay_audit.py

e11-pdf-render-boundary-audit: scripts/e11_write_pdf_render_boundary_audit.py
	$(PYTHON) scripts/e11_write_pdf_render_boundary_audit.py

e11-artifact-review-packet: scripts/e11_write_artifact_review_packet.py
	$(PYTHON) scripts/e11_write_artifact_review_packet.py

e11-camera-ready-package-audit: scripts/e11_write_camera_ready_package_audit.py
	$(PYTHON) scripts/e11_write_camera_ready_package_audit.py

e11-top-conference-claim-decision-audit: scripts/e11_write_top_conference_claim_decision_audit.py
	$(PYTHON) scripts/e11_write_top_conference_claim_decision_audit.py

e11-manuscript-claim-trace: scripts/e11_write_manuscript_claim_trace.py
	$(PYTHON) scripts/e11_write_manuscript_claim_trace.py

e11-mechanism-referee-audit: scripts/e11_write_mechanism_referee_audit.py
	$(PYTHON) scripts/e11_write_mechanism_referee_audit.py
...
e11-cifar-resnet-lt-tuned-benchmark-refresh-discussions: scripts/e11_run_cifar100_resnet_lt_tuned_benchmark.py
	$(PYTHON) scripts/e11_run_cifar100_resnet_lt_tuned_benchmark.py --refresh-discussions
...
e11-cifar-resnet-lt-tuned-benchmark-interim-audit: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_interim_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_interim_audit.py

e11-cifar-resnet-lt-tuned-benchmark-leakage-audit: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_leakage_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_leakage_audit.py

e11-cifar-resnet-lt-tuned-benchmark-refresh-firewall: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_refresh_firewall.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_refresh_firewall.py

e11-cifar-resnet-lt-tuned-benchmark-protocol-seal: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_protocol_seal.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_protocol_seal.py

e11-cifar-resnet-lt-tuned-benchmark-fairness-audit: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_fairness_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_fairness_audit.py

e11-cifar-resnet-lt-tuned-benchmark-power-audit: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_power_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_power_audit.py

e11-cifar-resnet-lt-tuned-benchmark-variance-prior-audit: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_variance_prior_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_variance_prior_audit.py

e11-cifar-resnet-lt-tuned-benchmark-final-analysis-plan: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_final_analysis_plan.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_final_analysis_plan.py

e11-cifar-resnet-lt-tuned-benchmark-final-robustness-plan: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_final_robustness_plan.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_final_robustness_plan.py

e11-cifar-resnet-lt-tuned-benchmark-final-execution-plan: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_final_execution_plan.py scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_final.sbatch
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_final_execution_plan.py

e11-cifar-resnet-lt-tuned-benchmark-final-eval: scripts/e11_evaluate_cifar100_resnet_lt_tuned_benchmark_final.py
	$(PYTHON) scripts/e11_evaluate_cifar100_resnet_lt_tuned_benchmark_final.py

e11-cifar-resnet-lt-tuned-benchmark-final-launch-audit: scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_final.py
	$(PYTHON) scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_final.py

e11-cifar-resnet-lt-tuned-benchmark-final-safe-submit: scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_final.py
	$(PYTHON) scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_final.py --submit

e11-cifar-resnet-lt-tuned-benchmark-slurm-plan: scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_slurm_plan.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_slurm_plan.py

e11-cifar-resnet-lt-tuned-benchmark-launch-audit: scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_validation.py
	$(PYTHON) scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_validation.py

e11-cifar-resnet-lt-tuned-benchmark-safe-submit: scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_validation.py
	$(PYTHON) scripts/e11_submit_cifar100_resnet_lt_tuned_benchmark_validation.py --submit
...
e11-natural-negative-search-phase2-settings: scripts/e11_run_natural_negative_search_phase2.py
	$(PYTHON) scripts/e11_run_natural_negative_search_phase2.py --settings-only

e11-natural-negative-search-phase2-results: scripts/e11_run_natural_negative_search_phase2.py scripts/slurm/e11_natural_negative_search_phase2.sbatch
	sbatch scripts/slurm/e11_natural_negative_search_phase2.sbatch

e11-natural-negative-search-phase2-eval: scripts/e11_evaluate_natural_negative_search_phase2.py
	$(PYTHON) scripts/e11_evaluate_natural_negative_search_phase2.py

e11-natural-negative-search-phase2-power-audit: scripts/e11_write_natural_negative_phase2_power_audit.py
	$(PYTHON) scripts/e11_write_natural_negative_phase2_power_audit.py

e11-heldout-generality-audit: scripts/e11_write_heldout_generality_audit.py
	$(PYTHON) scripts/e11_write_heldout_generality_audit.py

e11-bold-conjecture-register: scripts/e11_write_bold_conjecture_register.py
	$(PYTHON) scripts/e11_write_bold_conjecture_register.py

e11-muon-state-distribution-contract: scripts/e11_write_muon_state_distribution_contract.py
	$(PYTHON) scripts/e11_write_muon_state_distribution_contract.py

e11-paper-assets: e11-cifar-resnet-lt-tuned-benchmark-refresh-discussions
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_interim_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_leakage_audit.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_refresh_firewall.py
	$(PYTHON) scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_protocol_seal.py
