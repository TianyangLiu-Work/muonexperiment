...
Current missing validation cells: `141`. Planned chunks: `8`.
...
|:-------------|:-------------------|----------------:|:----------------------------------------------------------------|:------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------|:-------------------------------------------------------------------------------|:--------------------------|
| TBV-SLURM-01 | 23-42              |              20 | adamw_cb_loss_tuned;sgd_momentum_ce_tuned                       | sbatch --array=23-42%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch   | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-02 | 43-62              |              20 | adamw_cb_loss_tuned;adamw_cb_sampler_tuned;ns_muon_matrix_tuned | sbatch --array=43-62%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch   | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-03 | 63-82              |              20 | ns_muon_matrix_tuned                                            | sbatch --array=63-82%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch   | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-04 | 83-102             |              20 | ns_muon_matrix_tuned                                            | sbatch --array=83-102%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch  | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-05 | 103-122            |              20 | ns_muon_matrix_tuned                                            | sbatch --array=103-122%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-06 | 123-142            |              20 | ns_muon_cb_tuned;ns_muon_matrix_tuned                           | sbatch --array=123-142%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-07 | 143-162            |              20 | ns_muon_cb_tuned                                                | sbatch --array=143-162%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-08 | 163                |               1 | ns_muon_cb_tuned                                                | sbatch --array=163%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch     | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
