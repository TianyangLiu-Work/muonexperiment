...
Current missing validation cells: `118`. Planned chunks: `6`.
...
|:-------------|:-------------------|----------------:|:----------------------------------------------------------------|:------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------|:-------------------------------------------------------------------------------|:--------------------------|
| TBV-SLURM-01 | 46-65              |              20 | adamw_cb_loss_tuned;adamw_cb_sampler_tuned;ns_muon_matrix_tuned | sbatch --array=46-65%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch   | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-02 | 66-85              |              20 | ns_muon_matrix_tuned                                            | sbatch --array=66-85%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch   | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-03 | 86-105             |              20 | ns_muon_matrix_tuned                                            | sbatch --array=86-105%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch  | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-04 | 106-125            |              20 | ns_muon_matrix_tuned                                            | sbatch --array=106-125%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-05 | 126-145            |              20 | ns_muon_cb_tuned;ns_muon_matrix_tuned                           | sbatch --array=126-145%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
| TBV-SLURM-06 | 146-163            |              18 | ns_muon_cb_tuned                                                | sbatch --array=146-163%1 scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch | summary.csv; occupancy_trace.csv; class_metrics.csv; group_metrics.csv | rerun make e11-cifar-resnet-lt-tuned-benchmark-selection and inspect TVS gates | not_submitted_static_plan |
