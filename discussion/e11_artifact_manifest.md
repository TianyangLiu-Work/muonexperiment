...
| results                | Generated CSV evidence used by the paper table, discussion artifacts, and validator.  | commit current E11 evidence set          | 275.2 MB |
| figures                | Static figures used by the paper draft and paper-facing Markdown artifacts.           | commit static E11 figures                | 32.8 MB  |
...
| results/e11_cifar100_resnet_lt_tuned_benchmark/validation_selection/run_registry.csv                       |    164 | 75.3 KB   |
| results/e11_cifar100_resnet_lt_tuned_benchmark/validation_selection/family_selection.csv                   |      6 | 771 B     |
...
| results/e11_cifar100_resnet_lt_tuned_benchmark/slurm_submission_plan/chunk_plan.csv                        |      8 | 2.9 KB    |
...
| discussion/e11_cifar100_resnet_lt_tuned_benchmark_selection.md                              | 73.8 KB |
