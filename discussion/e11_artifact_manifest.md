...
|:-----------------------|:--------------------------------------------------------------------------------------|:-----------------------------------------|:---------|
| e11_condition_geometry | Source package for E11 problems, optimizers, diagnostics, reporting, and plotting.    | commit                                   | 727.9 KB |
| scripts                | Experiment runners, artifact writers, and validation scripts.                         | commit E11 scripts                       | 1.8 MB   |
| tests                  | Smoke tests, diagnostics tests, reporting tests, and validator guardrail tests.       | commit                                   | 239.8 KB |
| discussion             | Generated head-to-tail paper evidence plus legacy condition-geometry guardrail notes. | commit                                   | 694.3 KB |
| results                | Generated CSV evidence used by the paper table, discussion artifacts, and validator.  | commit current E11 evidence set          | 258.7 MB |
| figures                | Static figures used by the paper draft and paper-facing Markdown artifacts.           | commit static E11 figures                | 29.2 MB  |
| configs                | Experiment configuration snapshots.                                                   | commit                                   | 316 B    |
| paper                  | Head-to-tail LaTeX paper draft, generated paper table, and experiment triage notes.   | commit source and selected rendered PDFs | 4.0 MB   |
| Makefile               | Thin reproducibility entrypoint for E11 artifact generation and validation commands.  | commit                                   | 5.5 KB   |
...
| results/e11_cifar100_resnet_layer_jvp_checkpoint_prediction/prediction_pairs.csv   |     24 | 4.4 KB    |
| results/e11_cifar100_resnet_layer_jvp_checkpoint_prediction/prediction_summary.csv |      4 | 1.1 KB    |
...
| path                                                              | size    |
|:------------------------------------------------------------------|:--------|
| README_E11.md                                                     | 29.1 KB |
| discussion/e11_paper_skeleton.md                                  | 10.9 KB |
| discussion/e11_main_paper_package.md                              | 14.8 KB |
...
| discussion/e11_reproduction_checklist.md                          | 22.1 KB |
| discussion/e11_reviewer_risk_audit.md                             | 19.3 KB |
...
| discussion/e11_paper_readiness_audit.md                           | 24.8 KB |
| discussion/e11_top_conference_plan.md                             | 10.3 KB |
| discussion/e11_evidence_index.md                                  | 19.0 KB |
| discussion/e11_research_synthesis.md                              | 7.8 KB  |
| discussion/e11_research_direction_map.md                          | 9.8 KB  |
| discussion/e11_claim_validity_audit.md                            | 17.0 KB |
...
| discussion/e11_cifar100_resnet_layer_jvp_checkpoint_prediction.md | 5.7 KB  |
