...
|:-----------------------|:--------------------------------------------------------------------------------------|:-----------------------------------------|:---------|
| e11_condition_geometry | Source package for E11 problems, optimizers, diagnostics, reporting, and plotting.    | commit                                   | 417.1 KB |
| scripts                | Experiment runners, artifact writers, and validation scripts.                         | commit E11 scripts                       | 2.5 MB   |
| tests                  | Smoke tests, diagnostics tests, reporting tests, and validator guardrail tests.       | commit                                   | 65.0 KB  |
| discussion             | Generated head-to-tail paper evidence plus legacy condition-geometry guardrail notes. | commit                                   | 1.4 MB   |
| results                | Generated CSV evidence used by the paper table, discussion artifacts, and validator.  | commit current E11 evidence set          | 272.4 MB |
| figures                | Static figures used by the paper draft and paper-facing Markdown artifacts.           | commit static E11 figures                | 31.8 MB  |
...
| Makefile               | Thin reproducibility entrypoint for E11 artifact generation and validation commands.  | commit                                   | 18.1 KB  |
...
| results/e11_theory_proof_obligation_register/theorem_to_experiment_queue.csv                               |      7 | 1.5 KB    |
...
| results/e11_condition_score_v5_theory_to_score_map/claim_readiness_ledger.csv                              |      5 | 700 B     |
| results/e11_condition_score_ablation/score_ablation_summary.csv                                            |     32 | 10.2 KB   |
| results/e11_condition_score_ablation/term_failure_ladder.csv                                               |      5 | 1.7 KB    |
| results/e11_condition_score_ablation/leakage_and_claim_boundary.csv                                        |      4 | 894 B     |
...
| results/e11_condition_score_v5_protocol/final_score_evaluation/final_gate_report.csv                       |      6 | 1.1 KB    |
...
| results/e11_condition_score_v5_protocol/final_interpretation_plan/final_split_status.csv                   |      2 | 800 B     |
...
| results/e11_condition_score_v5_protocol/reviewer_failure_response/final_split_output_status.csv            |      2 | 771 B     |
| results/e11_condition_score_v5_protocol/reviewer_failure_response/current_gate_snapshot.csv                |      6 | 1.1 KB    |
| results/e11_condition_score_v5_protocol/reviewer_failure_response/active_failure_modes.csv                 |      3 | 1002 B    |
...
| results/e11_condition_score_v5_protocol/reviewer_failure_response/claim_downgrade_actions.csv              |      6 | 1.9 KB    |
| results/e11_condition_score_v5_protocol/reviewer_failure_response/next_evidence_queue.csv                  |      5 | 1.1 KB    |
...
| results/e11_natural_negative_search_protocol/protocol_status.csv                                           |      7 | 1.7 KB    |
...
| results/e11_natural_negative_search_protocol/phase2_multiplicity_evaluation/run_registry.csv               |      1 | 466 B     |
| results/e11_natural_negative_search_protocol/phase2_multiplicity_evaluation/seed_level_primary_ratios.csv  |      0 | 306 B     |
| results/e11_natural_negative_search_protocol/phase2_multiplicity_evaluation/primary_decisions.csv          |      8 | 3.1 KB    |
| results/e11_natural_negative_search_protocol/phase2_multiplicity_evaluation/gate_report.csv                |      5 | 624 B     |
...
| results/e11_top_conference_gap_register/gap_register.csv                                                   |      7 | 22.7 KB   |
...
| results/e11_top_conference_claim_decision_audit/manuscript_edit_queue.csv                                  |      6 | 2.8 KB    |
...
| results/e11_mechanism_referee_audit/alternative_explanation_matrix.csv                                     |      9 | 5.5 KB    |
| results/e11_mechanism_referee_audit/theory_measurement_contract.csv                                        |      6 | 3.1 KB    |
| results/e11_mechanism_referee_audit/falsification_trigger_matrix.csv                                       |      6 | 2.6 KB    |
...
| results/e11_cifar100_resnet_lt_tuned_benchmark_protocol/selection_rules.csv                                |      5 | 898 B     |
| results/e11_cifar100_resnet_lt_tuned_benchmark_protocol/acceptance_gates.csv                               |      6 | 1.4 KB    |
| results/e11_cifar100_resnet_lt_tuned_benchmark/settings_registry.csv                                       |    164 | 100.3 KB  |
| results/e11_cifar100_resnet_lt_tuned_benchmark/execution_status.csv                                        |      1 | 189 B     |
| results/e11_cifar100_resnet_lt_tuned_benchmark/validation_selection/run_registry.csv                       |    164 | 46.7 KB   |
...
| results/e11_cifar100_resnet_lt_tuned_benchmark/validation_selection/gate_report.csv                        |      4 | 388 B     |
| results/e11_cifar100_resnet_lt_tuned_benchmark/final_power_audit/final_family_design.csv                   |      6 | 1.5 KB    |
...
| discussion/e11_quantitative_claim_ledger.md                                                 | 19.8 KB |
| discussion/e11_reproduction_checklist.md                                                    | 60.9 KB |
...
| discussion/e11_top_conference_gap_register.md                                               | 55.4 KB |
| discussion/e11_top_conference_claim_decision_audit.md                                       | 28.1 KB |
| discussion/e11_manuscript_claim_trace.md                                                    | 7.0 KB  |
| discussion/e11_mechanism_referee_audit.md                                                   | 25.5 KB |
| discussion/e11_natural_head_tail_boundary.md                                                | 17.5 KB |
| discussion/e11_natural_negative_search_protocol.md                                          | 19.5 KB |
...
| discussion/e11_natural_negative_search_phase2_NNS-P2-heldout-architecture-boundary.md       | 3.2 KB  |
| discussion/e11_natural_negative_search_phase2_evaluation.md                                 | 5.2 KB  |
...
| discussion/e11_theory_proof_obligation_register.md                                          | 16.0 KB |
...
| discussion/e11_condition_score_v5_final_evaluation.md                                       | 5.0 KB  |
...
| discussion/e11_condition_score_v5_reviewer_failure_response.md                              | 18.1 KB |
