...
|:-----------------------|:--------------------------------------------------------------------------------------|:-----------------------------------------|:---------|
| e11_condition_geometry | Source package for E11 problems, optimizers, diagnostics, reporting, and plotting.    | commit                                   | 425.4 KB |
...
| Makefile               | Thin reproducibility entrypoint for E11 artifact generation and validation commands.  | commit                                   | 20.8 KB  |
...
| results/e11_artifact_review_packet/command_matrix.csv                                                      |     10 | 3.6 KB    |
| results/e11_artifact_review_packet/gate_matrix.csv                                                         |      6 | 1.6 KB    |
| results/e11_artifact_review_packet/local_state_contract.csv                                                |      9 | 2.1 KB    |
| results/e11_artifact_review_packet/reviewer_response.csv                                                   |      8 | 2.9 KB    |
...
| discussion/e11_artifact_review_packet.md                                                    | 20.6 KB |
