...
|:-----------------------|:--------------------------------------------------------------------------------------|:-----------------------------------------|:---------|
| e11_condition_geometry | Source package for E11 problems, optimizers, diagnostics, reporting, and plotting.    | commit                                   | 375.0 KB |
...
| discussion             | Generated head-to-tail paper evidence plus legacy condition-geometry guardrail notes. | commit                                   | 861.2 KB |
...
| results/e11_top_conference_gap_register/gap_register.csv                                              |      7 | 7.1 KB    |
...
| discussion/e11_top_conference_gap_register.md                               | 15.9 KB |
