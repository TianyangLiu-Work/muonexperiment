...
|:-------------------------------------------------------------------------------------|:--------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Muon has a distinct update-spectrum geometry.                                        | supported                                               | Equal-update nrUpdate ratio=2.017 CI=[1.905,2.136], stUpdate ratio=4.765 CI=[4.582,4.955].                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | This is partly by construction for exact polar Muon, so it is a mechanism fact, not a surprise performance result.                                                                   |
| Muon is globally better than Adam on short-horizon progress.                         | not supported                                           | All-task first-order ratio=0.5257 CI=[0.4985,0.5545]; MF ratio=0.3432, Matrix Sensing ratio=1.236.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | The result is task-dependent; aggregate ratios hide opposite family-level behavior.                                                                                                  |
| One-step progress is explained by gradient-update alignment.                         | supported for these short steps                         | All equal-update Spearman(delta_loss, <G,D>)=0.9803 CI=[0.9787,0.9817], within-factor-2=0.9207.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | This validates a first-order local diagnostic, not long-horizon optimization or generalization.                                                                                      |
...
|:-------------|:-----------------|----------:|--------------------:|-------------------------------:|-----------------:|------------------:|:-----------------------|
| nrUpdate     | All              |       165 |                 165 |                          2.017 |            1.905 |             2.136 | yes                    |
| stUpdate     | All              |       165 |                 165 |                          4.765 |            4.582 |             4.955 | yes                    |
| nrUpdateFrac | All              |       165 |                 165 |                          1.953 |            1.845 |             2.068 | yes                    |
| stUpdateFrac | All              |       165 |                 165 |                          4.451 |            4.378 |             4.525 | yes                    |
...
|:------------------|:-------------------------|----------:|--------------------:|-------------------------------:|-----------------:|------------------:|:-----------------------|-----------------------------:|
| delta_loss        | All                      |      1275 |                 437 |                         0.5488 |           0.5197 |            0.5795 | no                     |                   -0.001374  |
| delta_loss        | MatrixFactorizationInput |       750 |                  96 |                         0.3823 |           0.3537 |            0.4133 | no                     |                   -2.023e-06 |
| delta_loss        | MatrixSensing            |       375 |                 341 |                         1.162  |           1.127  |            1.197  | yes                    |                    0.0004982 |
| delta_loss        | SmallMLPDigits           |       150 |                   0 |                         0.5128 |           0.48   |            0.5478 | no                     |                   -0.01291   |
| update_grad_inner | All                      |      1275 |                 407 |                         0.5257 |           0.4985 |            0.5545 | no                     |                   -0.00101   |
| update_grad_inner | MatrixFactorizationInput |       750 |                  54 |                         0.3432 |           0.3194 |            0.3687 | no                     |                   -5.23e-06  |
| update_grad_inner | MatrixSensing            |       375 |                 353 |                         1.236  |           1.215  |            1.258  | yes                    |                    0.001344  |
| update_grad_inner | SmallMLPDigits           |       150 |                   0 |                         0.5232 |           0.4909 |            0.5576 | no                     |                   -0.01192   |
...
|:--------|---------:|------------------:|--------------------------------:|--------------------:|---------------------:|------------------:|
| All     |     2550 |              2496 |                          0.9803 |              0.9787 |               0.9817 |            0.9207 |
| Adam    |     1275 |              1221 |                          0.9688 |              0.9652 |               0.972  |            0.9132 |
| Muon    |     1275 |              1275 |                          0.996  |              0.9955 |               0.9964 |            0.9278 |
...
|:---------------------|:--------------|:-------------------------|--------------:|-------------:|---------------------:|:-------|:--------------------|--------:|-----------------:|
| muon_first_order_win | spectrum_only | MatrixFactorizationInput |           525 |          750 |               0.072  | 0.4716 | 0.4986              | 0.07406 |          0.06682 |
| muon_first_order_win | spectrum_only | MatrixSensing            |           900 |          375 |               0.9413 | 0.5    | 0.5                 | 0.9413  |          0.05522 |
