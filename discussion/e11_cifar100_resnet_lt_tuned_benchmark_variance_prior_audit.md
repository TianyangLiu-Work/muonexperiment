...
| EVPA-2-validation-sd-surface         | pass     | 100 validation frequency-group variance rows                                       | completed validation settings provide within-setting seed variability             |
...
|:--------------------------|:------------------|------------:|---------:|---------:|---------:|---------:|-------------------------:|:--------------------------|:--------------------------------------------------------------------------------|
| validation_within_setting | all               |          25 | 0.006207 | 0.008426 | 0.01696  | 0.1826   |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | few               |          25 | 0.006298 | 0.008483 | 0.01243  | 0.03988  |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | many              |          25 | 0.009206 | 0.01156  | 0.02237  | 0.315    |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | medium            |          25 | 0.008445 | 0.01262  | 0.02385  | 0.1733   |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
...
|:--------------------------|:------------------|:---------------|-----------------:|----------------------:|------------------------------------------:|:----------------------------------------------------------------------------------------------------------------|
| validation_within_setting | all               | p80            |         0.008426 |              0.008289 |                                -0.001711  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
| validation_within_setting | all               | p95            |         0.01696  |              0.01668  |                                 0.006682  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
...
| validation_within_setting | few               | p80            |         0.008483 |              0.008345 |                                -0.001655  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
| validation_within_setting | few               | p95            |         0.01243  |              0.01223  |                                 0.002229  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
