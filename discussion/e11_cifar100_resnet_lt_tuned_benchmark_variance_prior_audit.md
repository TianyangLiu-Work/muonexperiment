...
| EVPA-2-validation-sd-surface         | pass     | 188 validation frequency-group variance rows                                       | completed validation settings provide within-setting seed variability             |
...
|:--------------------------|:------------------|------------:|---------:|---------:|---------:|---------:|-------------------------:|:--------------------------|:--------------------------------------------------------------------------------|
| validation_within_setting | all               |          47 | 0.006483 | 0.009134 | 0.01239  | 0.1826   |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | few               |          47 | 0.006521 | 0.008384 | 0.01242  | 0.03988  |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | many              |          47 | 0.00989  | 0.0126   | 0.01538  | 0.315    |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | medium            |          47 | 0.009373 | 0.01275  | 0.01509  | 0.1733   |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
...
| validation_within_setting | all               | p95            |         0.01239  |              0.01219  |                                 0.002191  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
...
| validation_within_setting | few               | p80            |         0.008384 |              0.008248 |                                -0.001752  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
