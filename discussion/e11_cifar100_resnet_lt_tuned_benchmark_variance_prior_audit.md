...
| EVPA-2-validation-sd-surface         | pass     | 180 validation frequency-group variance rows                                       | completed validation settings provide within-setting seed variability             |
...
|:--------------------------|:------------------|------------:|---------:|---------:|---------:|---------:|-------------------------:|:--------------------------|:--------------------------------------------------------------------------------|
| validation_within_setting | all               |          45 | 0.006311 | 0.008895 | 0.01245  | 0.1826   |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | few               |          45 | 0.006449 | 0.008483 | 0.01243  | 0.03988  |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | many              |          45 | 0.009779 | 0.01257  | 0.01471  | 0.315    |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | medium            |          45 | 0.009182 | 0.01278  | 0.0152   | 0.1733   |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
...
|:--------------------------|:------------------|:---------------|-----------------:|----------------------:|------------------------------------------:|:----------------------------------------------------------------------------------------------------------------|
| validation_within_setting | all               | p80            |         0.008895 |              0.008751 |                                -0.001249  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
| validation_within_setting | all               | p95            |         0.01245  |              0.01224  |                                 0.002244  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
