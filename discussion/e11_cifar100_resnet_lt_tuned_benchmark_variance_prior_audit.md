...
| EVPA-2-validation-sd-surface         | pass     | 72 validation frequency-group variance rows                                        | completed validation settings provide within-setting seed variability             |
...
|:--------------------------|:------------------|------------:|---------:|---------:|---------:|---------:|-------------------------:|:--------------------------|:--------------------------------------------------------------------------------|
| validation_within_setting | all               |          18 | 0.005566 | 0.007483 | 0.00841  | 0.008677 |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | few               |          18 | 0.005768 | 0.006562 | 0.007243 | 0.009518 |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | many              |          18 | 0.009119 | 0.01103  | 0.01388  | 0.01489  |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
| validation_within_setting | medium            |          18 | 0.008299 | 0.01099  | 0.01299  | 0.01357  |                     0.03 | yes                       | within-setting seed SD is a loose variance prior                                |
...
|:--------------------------|:------------------|:---------------|-----------------:|----------------------:|------------------------------------------:|:----------------------------------------------------------------------------------------------------------------|
| validation_within_setting | all               | p80            |         0.007483 |              0.007361 |                                -0.002639  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
| validation_within_setting | all               | p95            |         0.00841  |              0.008274 |                                -0.001726  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
...
| validation_within_setting | few               | p80            |         0.006562 |              0.006455 |                                -0.003545  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
| validation_within_setting | few               | p95            |         0.007243 |              0.007125 |                                -0.002875  | MDE sensitivity only; final benchmark claim remains blocked until validation selection and final seeds complete |
