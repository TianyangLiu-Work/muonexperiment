...
| The rank boundary is not yet a natural-task predictor. | The synthetic boundary is presented as a controlled mechanism check; the condition-score program is frozen and the completed v5 final gates failed under the registered protocol. | Preserve the ResNeXt50 direction-threshold failure and CIFAR-10 residual-ranking reversal, and use a new unspent protocol for any repaired score. |
