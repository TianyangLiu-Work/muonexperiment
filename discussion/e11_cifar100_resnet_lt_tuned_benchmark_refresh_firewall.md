...
|:------------------------------|:-----------------------------|--------------------------------:|----------------------------:|-----------------------------:|----------------------------:|------------------------:|:-------------------------|---------------------------:|:--------------------|:-------------------------|:-----------------------------------|
| VRF-current-validation-prefix | partial_grid_no_claim_change |                              50 |                         164 |                           50 |                           3 |                       6 | 0..49                    |                         50 | yes                 | progress_accounting_only | blocked_until_TVS_FEP_TFE_FLA_pass |

## Allowed Transition Matrix

| transition_id                      | status    | trigger                                                                 | required_commands                                                                                            | allowed_output                                                      |
|:-----------------------------------|:----------|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------|
| VRF-A1-prefix-result-refresh       | pass      | new validation summary and occupancy trace for array index 50           | rerun selection, interim audit, leakage audit, and refresh firewall                                          | updated progress accounting with no selection-authority change      |
