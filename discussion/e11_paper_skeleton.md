...
|:---------------------------------------------------------------------------------------|:---------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------|
| Muon shapes update spectra.                                                            | main claim                 | `nrUpdate` ratio 2.017 [1.905, 2.136]; `stUpdate` ratio 4.765 [4.582, 4.955].                                                                                                                   | update-spectrum robustness; cross-task signature table |
| One-step progress can be analyzed through gradient-update alignment.                   | diagnostic claim           | Spearman(delta_loss, <G,D>)=0.9803 [0.9787, 0.9817].                                                                                                                                            | first-order calibration                                |
...
| Muon advantage is conditional, not universal.                                          | boundary claim             | Matrix Sensing ratio 1.236; MF ratio 0.3432; MLP hidden=64 ratio 0.6047.                                                                                                                        | mechanism boundary map                                 |
