...
| FAP-2-family-selection-readiness | not_ready | 3/6 families ready for final run                                                 | final analysis cannot run until one recipe per family is selected |
...
|:------------------------------|:-----------------------|:--------------------|:---------------------------------------------------------|:-----------------|:----------------------------------------------------------------------------------------|:--------------|:-----------------------------------------------------------------------------|
| FIN-IN-adamw_cb_loss_tuned    | adamw_cb_loss_tuned    | ready_for_final_run | TBV-adamw_cb_loss_tuned-beta0p9999-lr1e-3-wd1e-4-warm500 | 20..29           | summary.csv; group_metrics.csv; class_metrics.csv; train_trace.csv; occupancy_trace.csv | seed          | required for final analysis only after all six families are selected and run |
...
| FIN-IN-sgd_momentum_ce_tuned  | sgd_momentum_ce_tuned  | ready_for_final_run | TBV-sgd_momentum_ce_tuned-lr0p3-wd1e-3-warm500           | 20..29           | summary.csv; group_metrics.csv; class_metrics.csv; train_trace.csv; occupancy_trace.csv | seed          | required for final analysis only after all six families are selected and run |
