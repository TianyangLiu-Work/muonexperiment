...
|:-------------------------|:---------------------------|:------------------|:------------------------|--------:|:-----------------|:----------------------|:--------------------------------------------------------------------------------------------------|
| task_family              | MatrixFactorizationInput   | update_grad_inner | Muon/Adam               |  0.3606 | [0.3361, 0.3869] | Adam/GD-favorable     | At matched global update size, does Muon's natural update improve <G,D>?                          |
| task_family              | MatrixSensing              | update_grad_inner | Muon/Adam               |  1.209  | [1.148, 1.274]   | Muon-favorable        | At matched global update size, does Muon's natural update improve <G,D>?                          |
| task_family              | SmallMLPDigits             | update_grad_inner | Muon/Adam               |  0.4942 | [0.4639, 0.5266] | Adam/GD-favorable     | At matched global update size, does Muon's natural update improve <G,D>?                          |
...
|:-------------------------|:---------------------------|:------------------------|--------:|:-----------------|:---------------------|:-----------------------------------------------------------------------------------------------------------------------|
| task_family              | MatrixSensing              | Muon/Adam               |  1.209  | [1.148, 1.274]   | Muon-favorable       | Task family alone can flip whether Muon's update spectrum improves local first-order progress.                         |
...
| boundary_axis         | condition                  | ratio_label            |   ratio | ci95             | direction             | interpretation                                                                                            |
|:----------------------|:---------------------------|:-----------------------|--------:|:-----------------|:----------------------|:----------------------------------------------------------------------------------------------------------|
| task_family           | MatrixFactorizationInput   | Muon/Adam              |  0.3606 | [0.3361, 0.3869] | Adam/GD-favorable     | Task family alone can flip whether Muon's update spectrum improves local first-order progress.            |
| task_family           | SmallMLPDigits             | Muon/Adam              |  0.4942 | [0.4639, 0.5266] | Adam/GD-favorable     | Task family alone can flip whether Muon's update spectrum improves local first-order progress.            |
