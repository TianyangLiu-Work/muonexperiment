...
| Held-out checkpoint-transfer JVP benchmark | Across tail-rich 2000/5000/10000-step ResNet checkpoints, source-observed positive-control Spearman is `0.981 [0.9739, 0.988]` and early-layer prior Spearman is `0.9126 [0.9029, 0.9222]`, but scaled-JVP held-out layer-risk Spearman is `-0.3203 [-0.3562, -0.2845]` despite below-one threshold accuracy `1`. | predictive boundary |
...
the below-one direction but not that ranking. This narrows the failure to the
condition score rather than target-checkpoint noise. The standard reporting
