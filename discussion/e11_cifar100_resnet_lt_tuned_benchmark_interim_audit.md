...
Current progress: `30/164` validation settings complete. The current completed-setting leader is `TBV-adamw_ce_tuned-lr1e-3-wd5e-4-warm0` with few balanced accuracy `0.1121` and all balanced accuracy `0.4151`.
...
| IVA-2-partial-grid-blocks-selection  | not_ready | 30/164 validation settings complete                                              | completed-setting leaderboard with no selection authority | selection from incomplete recipe families |
...
| IVA-4-occupancy-coverage             | not_ready | 30/164 occupancy traces complete                                                 | interim occupancy coverage                                | trajectory state-distribution claim       |
...
|:----------------------------------------|:----------|:-------------------------------------------------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|
| IPG-1-completed-prefix-auditable        | pass      | completed array indices span 0..29; next missing array index 30                            | progress accounting only                                | cherry-picking non-contiguous validation settings |
...
| IPG-3-occupancy-paired-with-validation  | pass      | 30/30 completed settings have occupancy traces with positive probe rows; min probe rows 30 | paired occupancy progress readout                       | trajectory occupancy claim before full grid       |
| IPG-4-missing-work-blocks-final-readout | not_ready | 134/164 settings still lack validation summaries                                           | no final-performance benchmark result                   | final seed launch or benchmark result wording     |
...
|:-----------------------|--------------------:|--------------------:|--------------------:|:----------------|:------------------------------------------------------|---------------------------------------:|---------------------------------------:|:-----------------------------------------------------|:---------------------------|
| adamw_cb_loss_tuned    |                  24 |                   6 |                0.25 | partial         | TBV-adamw_cb_loss_tuned-beta0p999-lr3e-4-wd1e-4-warm0 |                                 0.076  |                                 0.3297 | current_global_best_ci_low_above_family_best_ci_high | not_allowed_partial_family |
...
|:-----------------------|--------------------:|------------------------------:|-----------------------:|--------------------------:|-----------------------:|--------------------------------------------:|:-----------------------------|
| adamw_cb_loss_tuned    |                  24 |                             6 |                    180 |                   0.02786 |                  6.721 |                                      0.4892 | not_ready_full_grid_required |
