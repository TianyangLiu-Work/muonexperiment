...
Current progress: `20/164` validation settings complete. The current completed-setting leader is `TBV-adamw_ce_tuned-lr1e-3-wd5e-4-warm0` with few balanced accuracy `0.1121` and all balanced accuracy `0.4151`.
...
| IVA-2-partial-grid-blocks-selection  | not_ready | 20/164 validation settings complete                                              | completed-setting leaderboard with no selection authority | selection from incomplete recipe families |
...
| IVA-4-occupancy-coverage             | not_ready | 20/164 occupancy traces complete                                                 | interim occupancy coverage                                | trajectory state-distribution claim       |
...
|:----------------------------------------|:----------|:-------------------------------------------------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|
| IPG-1-completed-prefix-auditable        | pass      | completed array indices span 0..19; next missing array index 20                            | progress accounting only                                | cherry-picking non-contiguous validation settings |
...
| IPG-3-occupancy-paired-with-validation  | pass      | 20/20 completed settings have occupancy traces with positive probe rows; min probe rows 30 | paired occupancy progress readout                       | trajectory occupancy claim before full grid       |
| IPG-4-missing-work-blocks-final-readout | not_ready | 144/164 settings still lack validation summaries                                           | no final-performance benchmark result                   | final seed launch or benchmark result wording     |
...
| sgd_momentum_ce_tuned  |                  12 |                   8 |              0.6667 | partial         | TBV-sgd_momentum_ce_tuned-lr0p1-wd1e-3-warm500 |                                0.08753 |                                 0.4302 | current_global_best_ci_low_above_family_best_ci_high | not_allowed_partial_family |
...
|      5 |            19 | TBV-sgd_momentum_ce_tuned-lr0p1-wd1e-3-warm500  | sgd_momentum_ce_tuned |                 0.08753 |                          0.07676 |                           0.09831 |                  0.4302 | no_partial_grid_only |
|      6 |             4 | TBV-adamw_ce_tuned-lr3e-4-wd1e-4-warm0          | adamw_ce_tuned        |                 0.0866  |                          0.08456 |                           0.08864 |                  0.3669 | no_partial_grid_only |
|      7 |            12 | TBV-sgd_momentum_ce_tuned-lr0p03-wd5e-4-warm0   | sgd_momentum_ce_tuned |                 0.0844  |                          0.07847 |                           0.09033 |                  0.3789 | no_partial_grid_only |
|      8 |             6 | TBV-adamw_ce_tuned-lr3e-4-wd5e-4-warm0          | adamw_ce_tuned        |                 0.08367 |                          0.07954 |                           0.08779 |                  0.3669 | no_partial_grid_only |
|      9 |            13 | TBV-sgd_momentum_ce_tuned-lr0p03-wd5e-4-warm500 | sgd_momentum_ce_tuned |                 0.08307 |                          0.07457 |                           0.09156 |                  0.3793 | no_partial_grid_only |
|     10 |             7 | TBV-adamw_ce_tuned-lr3e-4-wd5e-4-warm500        | adamw_ce_tuned        |                 0.08253 |                          0.07424 |                           0.09083 |                  0.3587 | no_partial_grid_only |
|     11 |             5 | TBV-adamw_ce_tuned-lr3e-4-wd1e-4-warm500        | adamw_ce_tuned        |                 0.08047 |                          0.07858 |                           0.08235 |                  0.3595 | no_partial_grid_only |
|     12 |            18 | TBV-sgd_momentum_ce_tuned-lr0p1-wd1e-3-warm0    | sgd_momentum_ce_tuned |                 0.07893 |                          0.06348 |                           0.09438 |                  0.4204 | no_partial_grid_only |
...
| sgd_momentum_ce_tuned  |                  12 |                             8 |                    240 |                   0.02786 |                  5.021 |                                      0.5598 | not_ready_full_grid_required |
