...
Current progress: `18/164` validation settings complete. The current completed-setting leader is `TBV-adamw_ce_tuned-lr1e-3-wd5e-4-warm0` with few balanced accuracy `0.1121` and all balanced accuracy `0.4151`.
...
| IVA-2-partial-grid-blocks-selection  | not_ready | 18/164 validation settings complete                                              | completed-setting leaderboard with no selection authority | selection from incomplete recipe families |
...
| IVA-4-occupancy-coverage             | not_ready | 18/164 occupancy traces complete                                                 | interim occupancy coverage                                | trajectory state-distribution claim       |
...
|:----------------------------------------|:----------|:-------------------------------------------------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|
| IPG-1-completed-prefix-auditable        | pass      | completed array indices span 0..17; next missing array index 18                            | progress accounting only                                | cherry-picking non-contiguous validation settings |
...
| IPG-3-occupancy-paired-with-validation  | pass      | 18/18 completed settings have occupancy traces with positive probe rows; min probe rows 30 | paired occupancy progress readout                       | trajectory occupancy claim before full grid       |
| IPG-4-missing-work-blocks-final-readout | not_ready | 146/164 settings still lack validation summaries                                           | no final-performance benchmark result                   | final seed launch or benchmark result wording     |
...
| sgd_momentum_ce_tuned  |                  12 |                   6 |                 0.5 | partial         | TBV-sgd_momentum_ce_tuned-lr0p03-wd5e-4-warm0 |                                 0.0844 |                                 0.3789 | current_global_best_ci_low_above_family_best_ci_high | not_allowed_partial_family |
...
|     11 |            17 | TBV-sgd_momentum_ce_tuned-lr0p1-wd5e-4-warm500  | sgd_momentum_ce_tuned |                 0.07887 |                          0.06705 |                           0.09068 |                  0.4108 | no_partial_grid_only |
|     12 |            16 | TBV-sgd_momentum_ce_tuned-lr0p1-wd5e-4-warm0    | sgd_momentum_ce_tuned |                 0.07093 |                          0.06386 |                           0.07801 |                  0.3991 | no_partial_grid_only |
...
| sgd_momentum_ce_tuned  |                  12 |                             6 |                    180 |                   0.02786 |                  5.005 |                                      0.5667 | not_ready_full_grid_required |
