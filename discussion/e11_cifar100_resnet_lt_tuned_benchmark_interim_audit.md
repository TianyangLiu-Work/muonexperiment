...
Current progress: `44/164` validation settings complete. The current completed-setting leader is `TBV-adamw_ce_tuned-lr1e-3-wd5e-4-warm0` with few balanced accuracy `0.1121` and all balanced accuracy `0.4151`.
...
| IVA-2-partial-grid-blocks-selection  | not_ready | 44/164 validation settings complete                                              | completed-setting leaderboard with no selection authority | selection from incomplete recipe families |
...
| IVA-4-occupancy-coverage             | not_ready | 44/164 occupancy traces complete                                                 | interim occupancy coverage                                | trajectory state-distribution claim       |
...
|:----------------------------------------|:----------|:-------------------------------------------------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|
| IPG-1-completed-prefix-auditable        | pass      | completed array indices span 0..43; next missing array index 44                            | progress accounting only                                | cherry-picking non-contiguous validation settings |
...
| IPG-3-occupancy-paired-with-validation  | pass      | 44/44 completed settings have occupancy traces with positive probe rows; min probe rows 30 | paired occupancy progress readout                       | trajectory occupancy claim before full grid       |
| IPG-4-missing-work-blocks-final-readout | not_ready | 120/164 settings still lack validation summaries                                           | no final-performance benchmark result                   | final seed launch or benchmark result wording     |
...
|:-----------------------|--------------------:|--------------------:|--------------------:|:----------------|:--------------------------------------------------------|---------------------------------------:|---------------------------------------:|:-----------------------------------------------------|:---------------------------|
| adamw_cb_loss_tuned    |                  24 |                  20 |              0.8333 | partial         | TBV-adamw_cb_loss_tuned-beta0p999-lr1e-3-wd1e-4-warm500 |                                0.09147 |                                 0.3609 | current_global_best_ci_low_above_family_best_ci_high | not_allowed_partial_family |
...
|      7 |            33 | TBV-adamw_cb_loss_tuned-beta0p999-lr1e-3-wd1e-4-warm500 | adamw_cb_loss_tuned   |                 0.09147 |                          0.08226 |                           0.1007  |                  0.3609 | no_partial_grid_only |
|      8 |            35 | TBV-adamw_cb_loss_tuned-beta0p999-lr1e-3-wd5e-4-warm500 | adamw_cb_loss_tuned   |                 0.09093 |                          0.08088 |                           0.101   |                  0.359  | no_partial_grid_only |
|      9 |            19 | TBV-sgd_momentum_ce_tuned-lr0p1-wd1e-3-warm500          | sgd_momentum_ce_tuned |                 0.08753 |                          0.07676 |                           0.09831 |                  0.4302 | no_partial_grid_only |
|     10 |             4 | TBV-adamw_ce_tuned-lr3e-4-wd1e-4-warm0                  | adamw_ce_tuned        |                 0.0866  |                          0.08456 |                           0.08864 |                  0.3669 | no_partial_grid_only |
|     11 |            32 | TBV-adamw_cb_loss_tuned-beta0p999-lr1e-3-wd1e-4-warm0   | adamw_cb_loss_tuned   |                 0.085   |                          0.07282 |                           0.09718 |                  0.346  | no_partial_grid_only |
|     12 |            34 | TBV-adamw_cb_loss_tuned-beta0p999-lr1e-3-wd5e-4-warm0   | adamw_cb_loss_tuned   |                 0.085   |                          0.06644 |                           0.1036  |                  0.3451 | no_partial_grid_only |
...
|:-----------------------|--------------------:|------------------------------:|-----------------------:|--------------------------:|-----------------------:|--------------------------------------------:|:-----------------------------|
| adamw_cb_loss_tuned    |                  24 |                            20 |                    600 |                   0.02786 |                  7.285 |                                      0.4571 | not_ready_full_grid_required |
