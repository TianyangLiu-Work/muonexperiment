...
| TCD-4-natural-counterexample-or-finite-null | finite_null_candidate_with_caveats      | limitations                                                                    | present_as_finite_null_candidate_with_caveats |                       5 |                    5 | observed \(26/26\) settings@311; \texttt{raw\_worse\_rows=0}@311; finite registered phase1 null candidate@311; detectable-effect and tail-quality caveats@311; does not prove that no natural counterexample exists outside the registered phase1 space@311 | pass                   |
...
| TCD-4-natural-counterexample-or-finite-null | unqualified absence of natural counterexamples outside the registered phase1 space          | no                    | pass           |
| TCD-4-natural-counterexample-or-finite-null | quality-failed rows validate the mechanism                                                  | no                    | pass           |
