...
| NNS-P2-heldout-architecture-boundary       | phase2_fresh_generality_search | CIFAR-100-LT | ResNet34 CIFAR stem | 2000/5000          | 0.002/0.005                 |              8 | GPU via Slurm  | scripts/slurm/e11_natural_negative_search_phase2.sbatch | implemented_sbatch  |
...
|:--------------------------|:------------------------------|:------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| NNS-1-protocol-freeze     | fresh natural negative search | Protocol tables and discussion define the search and claim boundary before fresh outputs are used for any claim.              | protocol_status.csv records metric_outputs_not_run before jobs or partial_metric_outputs/metric_outputs_complete after jobs; natural claims stay blocked until the evaluator completeness gate passes |
...
| fresh natural search entrypoints         | implemented                  | scripts/e11_run_natural_negative_search_phase1.py, scripts/slurm/e11_natural_negative_search_phase1.sbatch, scripts/e11_run_natural_negative_search_phase2.py, and scripts/slurm/e11_natural_negative_search_phase2.sbatch are registered; scripts/e11_evaluate_natural_negative_search_phase2.py fixes the phase2 decision gate | yes                                |
| fresh natural search settings registries | locked                       | phase1_cifar100lt_resnet18, phase1_cifar10lt_resnet18, and phase1_tail_quality_controls settings_registry.csv files declare 26 total settings; phase2_heldout_architecture settings_registry.csv declares 8/8 ResNet34 held-out architecture settings                                                                            | yes                                |
...
Phase2 boundary: The ResNet34 held-out architecture settings registry is frozen at `results/e11_natural_negative_search_protocol/phase2_heldout_architecture/settings_registry.csv`; the phase2 evaluator is frozen at `results/e11_natural_negative_search_protocol/phase2_multiplicity_evaluation/*`; no phase2 metric rows are used until the Slurm job completes.
