...
| FEP-5-all-families-ready         | not_ready | 3/6 families ready_for_final_run                                                                                                                                                         | yes                   |
...
|--------------:|:-----------------------|:-----------------------------------|:---------------------------------------------------------|:-----------------------------------------------------|:-----------------|:---------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
|             0 | adamw_cb_loss_tuned    | blocked_until_selection_gates_pass | TBV-adamw_cb_loss_tuned-beta0p9999-lr1e-3-wd1e-4-warm500 | adamw_cb_loss_tuned_beta0p9999_lr1e-3_wd1e-4_warm500 | 20..29           | results/e11_cifar100_resnet_lt_tuned_benchmark/final_claim/adamw_cb_loss_tuned   | /data/conda_envs/SpatialQuantization/bin/python scripts/e11_run_cifar100_resnet_lt_tuned_benchmark.py --phase final_claim --final-family adamw_cb_loss_tuned --device cuda --no-download --progress   | no               |
