...
| NNS-E2-phase1-output-completeness | not_ready | NNS-P1-cifar100lt-resnet18-new-partitions=complete (12/12 rows); NNS-P1-cifar10lt-resnet18-cross-partitions=settings_only_no_metrics (0/8 rows); NNS-P1-tail-quality-controls=settings_only_no_metrics (0/6 rows) |
...
| NNS-E4-natural-primary-claim      | not_ready | 12/26 phase1 settings have primary metric rows                                                                                                                                                                    |
