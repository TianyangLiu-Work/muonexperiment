...
def main() -> None:
    ...
    lines = [
        ...
        "\\begin{table}[H]",
        "\\centering",
        "\\caption{Head-to-tail empirical evidence summary. Except for the practical imbalanced-training row, which compares actual NS-Muon-style and Adam training results, ratios are spectral/polar or Muon-style directions divided by Frobenius/GD. Values below $1$ mean lower perturbation of held-out tail logits.}",
        ...
        (
            ...
            + " & unit-JVP ratio > 1 before head-gain scaling \\\\"
        ),
        (
