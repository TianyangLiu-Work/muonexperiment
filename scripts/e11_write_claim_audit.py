        ...
        [
            {
                ...
                "status": "supported",
                "evidence": (
                    f"Positive condition drift ratio={fmt(positive['geomean_tail_output_drift_sq_ratio_spectral_over_fro'])} "
                    f"CI={ci(positive, 'tail_output_drift_sq_ratio_ci95_low', 'tail_output_drift_sq_ratio_ci95_high')}; "
                    f"negative condition drift ratio={fmt(negative['geomean_tail_output_drift_sq_ratio_spectral_over_fro'])} "
            ...
            {
                "claim": "Spectral/polar one-step updates reduce held-out tail logit drift at matched head gain.",
                ...
                "main_loophole": "The result is about logits/function drift, not tail accuracy or final performance.",
            },
            {
                "claim": "Lower tail logit drift implies lower tail loss or better tail accuracy.",
            ...
            },
            {
                ...
                "status": "not supported",
                "evidence": (
                    f"Unit JVP drift ratios are above one: layer 1="
            ...
            {
                "claim": "Matched-head-gain scaling explains the observed lower layerwise drift.",
    ...
    evidence_tables = pd.DataFrame(
        [
            ...
            },
            {
                ...
                "role": "Matched-head-gain held-out tail logit drift and performance caveat.",
            },
            {
