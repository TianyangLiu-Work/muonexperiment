...
def build_theory_measurement_contract(e: dict[str, object]) -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "current_evidence": f"freeze boundary: {freeze_status}; completed final evaluator: {final_status}",
            "supports": "validation-frozen candidate plus completed negative final boundary",
            "does_not_support": "P0 predictive-condition generality after completed final failures",
            "next_gate": "preserve the completed final failures and open a new unspent protocol before any score repair",
        },
        {
            ...
            "next_gate": "map completed final failures to the completed-final reviewer failure response",
        },
        {
    ...
    rows = [
        {
            ...
            "required_action": "Downgrade predictive-condition wording under the completed-final reviewer failure response.",
            "claim_downgrade": "completed final negative boundary with local mechanism plus falsification evidence only",
        },
        {
