...
def gap_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "required_next_evidence": "Keep the matrix-block theorem proof and tightness audit synchronized with the paper appendix, use the completed v5 final failures to derive separate architecture-transport and data-partition-transport obligations, and require a new preregistered protocol with new unspent splits before any repaired score is treated as predictive.",
        ...
        },
        {
            ...
            "risk_if_missing": "The finite phase1 null candidate is useful for falsifiability, but without held-out or larger-dataset replication it remains a bounded search result.",
        },
        {
