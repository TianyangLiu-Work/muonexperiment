...
def gap_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "current_state": "The synthetic sandwich-block condition gives the right sign boundary, discussion/e11_condition_score_theory_bridge.md separates the supported threshold-direction guardrail from failed residual-ranking targets, discussion/e11_condition_score_failure_mechanism_audit.md shows the current measurable score reverses on held-out ResNet50 bottleneck/downsample parameterization, discussion/e11_condition_score_v4_protocol.md registers a two-axis transport protocol before unspent final splits, discussion/e11_condition_score_v4_validation_freeze.md freezes the amplitude-minus-direction residual score after the validation-only split, discussion/e11_condition_score_v4_final_evaluation.md shows that this score still reverses on the CIFAR-10 mixed final data split, and discussion/e11_condition_score_v4_failure_mechanism_audit.md shows the v4 reversal is not a direction-threshold failure but an amplitude/depth aggregation failure.",
            "required_next_evidence": "Derive or state a computable downstream-aware score that reduces to the theorem quantities in the linear case, is estimable with finite-difference or autodiff JVPs in networks, explains both the fresh ResNet50 reversal and the v4 CIFAR-10 mixed amplitude/depth reversal, and is frozen before any new held-out architecture/data splits.",
            "acceptance_gate": "Add a theorem, proposition, or falsifiable conjecture plus an ablation showing which term makes the score fail or succeed on the checkpoint-transfer benchmark; future held-out splits must not reuse failed v2 or fresh v3 final results for tuning.",
            "compute_mode": "CPU plus optional GPU via Slurm",
            "planned_artifacts": "discussion/e11_condition_score_theory_bridge.md; discussion/e11_condition_score_failure_mechanism_audit.md; discussion/e11_condition_score_v4_protocol.md; discussion/e11_condition_score_v4_validation_freeze.md; discussion/e11_condition_score_v4_final_evaluation.md; discussion/e11_condition_score_v4_failure_mechanism_audit.md; results/e11_condition_score_failure_mechanism_audit/*; results/e11_condition_score_v4_protocol/*; results/e11_condition_score_v4_failure_mechanism_audit/*; results/e11_condition_score_ablation/*; figures/e11_condition_score_ablation/*",
