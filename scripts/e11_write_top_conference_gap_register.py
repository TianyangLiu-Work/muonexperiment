...
def gap_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "compute_mode": "GPU via Slurm",
            "planned_artifacts": "results/e11_cifar100_resnet_lt_tuned_benchmark_protocol/*; discussion/e11_cifar100_resnet_lt_tuned_benchmark_protocol.md; scripts/e11_write_cifar100_resnet_lt_tuned_benchmark_protocol.py; scripts/e11_run_cifar100_resnet_lt_tuned_benchmark.py; scripts/slurm/e11_cifar100_resnet_lt_tuned_benchmark_validation.sbatch; results/e11_cifar100_resnet_lt_tuned_benchmark/*; figures/e11_cifar100_resnet_lt_tuned_benchmark/*; discussion/e11_cifar100_resnet_lt_tuned_benchmark.md",
