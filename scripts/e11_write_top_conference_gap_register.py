    ...
    return [
        {
            ...
            "current_state": "The checkpoint-transfer benchmark is a boundary result, the initial condition-score protocol is recorded in discussion/e11_cifar100_resnet_condition_score_protocol.md, the locked ResNet18 retrospective v2 split passes, the registered v2 held-out ResNet34/CIFAR-10-LT evaluation fails, and the frozen fresh v3 zero-fit scaled-JVP revision is evaluated in discussion/e11_condition_score_fresh_evaluation.md: CIFAR-10 alternate partition passes residual ranking, but ResNet50 architecture fails residual ranking and early-layer-prior comparison. The obstruction is summarized in discussion/e11_condition_score_failure_mechanism_audit.md, the next unspent v4 protocol is registered in discussion/e11_condition_score_v4_protocol.md, and the validation-freeze boundary in discussion/e11_condition_score_v4_validation_freeze.md now passes with condition_score_v4_two_axis_amplitude_minus_direction.",
            "required_next_evidence": "Treat both the frozen v2 and fresh v3 held-out failures as obstructions, not tuning targets: keep the committed v4 validation-freeze artifact fixed, then evaluate only the unspent WideResNet50-2 and CIFAR-10 mixed-partition final splits with the frozen condition_score_v4_two_axis_amplitude_minus_direction score.",
            "acceptance_gate": "For v4, report positive held-out residual Spearman with a CI lower endpoint above zero on unspent architecture and data splits, threshold accuracy above 0.8, explicit early-layer/v2/v3/source-observed controls, and a statement that all failed v2/v3 final held-outs were quarantined from score fitting and selection.",
            "compute_mode": "GPU via Slurm",
            "planned_artifacts": "results/e11_cifar100_resnet_condition_score_protocol/*; results/e11_cifar100_resnet_condition_score_next/*; results/e11_condition_score_fresh_protocol/*; results/e11_condition_score_failure_mechanism_audit/*; results/e11_condition_score_v4_protocol/*; figures/e11_condition_score_fresh_protocol/*; figures/e11_condition_score_failure_mechanism_audit/*; figures/e11_condition_score_v4_protocol/*; discussion/e11_cifar100_resnet_condition_score_next.md; discussion/e11_cifar100_resnet_condition_score_next_heldout_evaluation.md; discussion/e11_condition_score_fresh_protocol.md; discussion/e11_condition_score_fresh_evaluation.md; discussion/e11_condition_score_failure_mechanism_audit.md; discussion/e11_condition_score_v4_protocol.md; discussion/e11_condition_score_v4_validation_freeze.md",
        ...
        },
        {
            ...
            "current_state": "The synthetic sandwich-block condition gives the right sign boundary, discussion/e11_condition_score_theory_bridge.md separates the supported threshold-direction guardrail from failed residual-ranking targets, discussion/e11_condition_score_failure_mechanism_audit.md shows the current measurable score reverses on held-out ResNet50 bottleneck/downsample parameterization, discussion/e11_condition_score_v4_protocol.md registers a two-axis transport protocol before unspent final splits, and discussion/e11_condition_score_v4_validation_freeze.md freezes the amplitude-minus-direction residual score after the validation-only split.",
            "required_next_evidence": "Derive or state a computable downstream-aware score that reduces to the theorem quantities in the linear case, is estimable with finite-difference or autodiff JVPs in networks, explains the fresh ResNet50 reversal, and is frozen before any new held-out architecture/data splits.",
            ...
            "planned_artifacts": "discussion/e11_condition_score_theory_bridge.md; discussion/e11_condition_score_failure_mechanism_audit.md; discussion/e11_condition_score_v4_protocol.md; discussion/e11_condition_score_v4_validation_freeze.md; results/e11_condition_score_failure_mechanism_audit/*; results/e11_condition_score_v4_protocol/*; results/e11_condition_score_ablation/*; figures/e11_condition_score_ablation/*",
