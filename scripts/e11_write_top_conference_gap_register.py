    ...
    return [
        {
            ...
            "required_next_evidence": "Evaluate the registered v5 ResNeXt50-32x4d architecture final and CIFAR-10 cross-partition final using the frozen validation-selected score, without using v2/v3/v4 final rows or v5 final rows for score fitting or selection.",
