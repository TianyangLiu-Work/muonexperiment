    ...
    return [
        {
            ...
            "current_state": "The checkpoint-transfer benchmark is a boundary result: source-observed drift and early-layer structure transfer layer-risk ranking, but scaled-JVP raw and residual rankings are inverted even though below-one threshold direction is preserved.",
            "required_next_evidence": "Pre-register a source-only condition score, then evaluate it on held-out checkpoints, a held-out architecture family, and a held-out data split without target-checkpoint fitting.",
            ...
            "planned_artifacts": "results/e11_cifar100_resnet_condition_score_next/*; figures/e11_cifar100_resnet_condition_score_next/*; discussion/e11_cifar100_resnet_condition_score_next.md",
        ...
        },
        {
            ...
            "current_state": "The synthetic sandwich-block condition gives the right sign boundary, while real-model score candidates currently act as guardrails rather than a positive predictor.",
            "required_next_evidence": "Derive or state a computable downstream-aware score that reduces to the theorem quantities in the linear case and is estimable with finite-difference or autodiff JVPs in networks.",
            "acceptance_gate": "Add a theorem, proposition, or falsifiable conjecture plus an ablation showing which term makes the score fail or succeed on the checkpoint-transfer benchmark.",
