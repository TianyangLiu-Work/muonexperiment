    ...
    return [
        {
            ...
            "current_state": "The checkpoint-transfer benchmark is a boundary result, and the next condition-score protocol is now pre-registered in discussion/e11_cifar100_resnet_condition_score_protocol.md with fixed scores, splits, leakage rules, and acceptance gates.",
            "required_next_evidence": "Run the registered protocol: fit the primary source-only calibrated residual condition score only on calibration splits, then evaluate it on held-out checkpoints, a held-out architecture family, and a held-out data split without target-checkpoint fitting.",
