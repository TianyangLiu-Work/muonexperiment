...
def gap_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "current_state": "The synthetic sandwich-block condition gives the right sign boundary, discussion/e11_matrix_block_theorem_proof.md now records the matched-gain theorem statement, sandwich sensitivity lemma, proof steps, assumptions, and claim implications, discussion/e11_condition_score_theory_bridge.md separates the supported threshold-direction guardrail from failed residual-ranking targets, discussion/e11_condition_score_failure_mechanism_audit.md shows the current measurable score reverses on held-out ResNet50 bottleneck/downsample parameterization, discussion/e11_condition_score_v4_protocol.md registers a two-axis transport protocol before unspent final splits, discussion/e11_condition_score_v4_validation_freeze.md freezes the amplitude-minus-direction residual score after the validation-only split, discussion/e11_condition_score_v4_final_evaluation.md shows that this score still reverses on the CIFAR-10 mixed final data split, discussion/e11_condition_score_v4_failure_mechanism_audit.md shows the v4 reversal is not a direction-threshold failure but an amplitude/depth aggregation failure, discussion/e11_theory_proof_obligation_register.md now maps theorem claims, assumptions, blocked wording, and pending empirical gates into a proof-obligation register, discussion/e11_condition_score_v5_theory_protocol.md states the sandwiched tail-drift contract plus a required partition/architecture transport term, discussion/e11_condition_score_v5_theory_to_score_map.md gives a transport-stable sandwich residual proposition plus theorem-to-feature lineage, discussion/e11_condition_score_v5_validation_freeze.md freezes the transport-normalized residual score before final outputs exist, discussion/e11_condition_score_v5_final_evaluation.md pre-registers the final residual, direction, baseline-dominance, and control-reporting gates, and discussion/e11_condition_score_v5_final_interpretation_plan.md locks the allowed claim states for all pass/fail patterns before final outputs exist.",
            "required_next_evidence": "Keep the matrix-block theorem proof contract synchronized with the paper appendix, wait for the registered v5 unspent final split jobs to finish, rerun the frozen residual-score evaluator, and preserve negative outcomes if the transport term fails on either final split.",
            ...
            "planned_artifacts": "discussion/e11_matrix_block_theorem_proof.md; discussion/e11_condition_score_theory_bridge.md; discussion/e11_condition_score_failure_mechanism_audit.md; discussion/e11_condition_score_v4_protocol.md; discussion/e11_condition_score_v4_validation_freeze.md; discussion/e11_condition_score_v4_final_evaluation.md; discussion/e11_condition_score_v4_failure_mechanism_audit.md; discussion/e11_theory_proof_obligation_register.md; discussion/e11_condition_score_v5_theory_protocol.md; discussion/e11_condition_score_v5_theory_to_score_map.md; discussion/e11_condition_score_v5_validation_freeze.md; discussion/e11_condition_score_v5_final_evaluation.md; discussion/e11_condition_score_v5_final_interpretation_plan.md; results/e11_matrix_block_theorem_proof/*; results/e11_condition_score_failure_mechanism_audit/*; results/e11_condition_score_v4_protocol/*; results/e11_condition_score_v4_failure_mechanism_audit/*; results/e11_theory_proof_obligation_register/*; results/e11_condition_score_v5_theory_protocol/*; results/e11_condition_score_v5_theory_to_score_map/*; results/e11_condition_score_v5_protocol/*; results/e11_condition_score_ablation/*; figures/e11_condition_score_ablation/*",
