        ...
        [
            {
                ...
                "entrypoint_status": "to_implement_before_run",
            },
            {
        ...
        [
            {
                ...
                "pass_condition": "protocol_status.csv marks fresh_search_outputs as not_run and the planned phase output directories are absent or empty",
            },
            {
    ...
    return pd.DataFrame(
        [
            ...
            },
            {
                ...
                "status": "not_run",
                "evidence": "planned phase output prefixes are not generated by this protocol",
                "blocks_stronger_claim_if_missing": "yes",
            },
            {
                "item": "multiplicity-adjusted evaluator",
                "status": "registered_not_implemented",
                "evidence": "NNS-3 requires adjusted decision columns in future evaluator outputs",
                "blocks_stronger_claim_if_missing": "yes",
            },
            {
...
{markdown_table(search_space, ["search_id", "phase", "dataset", "architecture", "checkpoint_steps", "target_head_gain_fraction", "max_settings", "compute_mode", "entrypoint_status"])}
